...
<body>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-4 site-logo">
                        <a href="index.html" class="text-black h2 mb-0">our story</a>
                    </div>
                ...
                <div class="row align-items-stretch retro-layout-2">
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry mb-30 v-height gradient"
                            style="background-image: url('{{ asset('cssfontend') }}/images/img_1.jpg');">
                        ...
                        <a href="single.html" class="h-entry v-height gradient"
                            style="background-image: url('{{ asset('cssfontend') }}/images/img_2.jpg');">
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry img-5 h-100 gradient"
                            style="background-image: url('{{ asset('cssfontend') }}/images/img_v_1.jpg');">
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry mb-30 v-height gradient"
                            style="background-image: url('{{ asset('cssfontend') }}/images/img_3.jpg');">
                        ...
                        <a href="single.html" class="h-entry v-height gradient"
                            style="background-image: url('{{ asset('cssfontend') }}/images/img_4.jpg');">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('cssfontend') }}/images/img_1.jpg"
                            ...
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 mr-3 float-left"><img
                                            src="{{ asset('cssfontend') }}/images/person_1.jpg" alt="Image"
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('cssfontend') }}/images/img_2.jpg"
                                    alt="Image" class="img-fluid rounded"></a>
                            <div class="excerpt">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('cssfontend') }}/images/img_3.jpg"
                                    alt="Image" class="img-fluid rounded"></a>
                            <div class="excerpt">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('cssfontend') }}/images/img_4.jpg"
                                    alt="Image" class="img-fluid rounded"></a>
                            <div class="excerpt">
                ...
                <div class="row mb-5">
                    <div class="col-md-4">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat reprehenderit magnam
                            deleniti quasi
                            saepe, consequatur atque sequi delectus dolore veritatis obcaecati quae, repellat eveniet
                            omnis,
    ...
    <script src="{{ asset('cssfontend') }}/js/jquery-3.3.1.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/jquery-migrate-3.0.1.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/jquery-ui.js"></script>
    <script src="{{ asset('cssfontend') }}/js/popper.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/bootstrap.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/owl.carousel.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/jquery.stellar.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/jquery.countdown.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/jquery.magnific-popup.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/bootstrap-datepicker.min.js"></script>
    <script src="{{ asset('cssfontend') }}/js/aos.js"></script>

    <script src="{{ asset('cssfontend') }}/js/main.js"></script>

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async="" src="{{ asset('cssfontend') }}/../../gtag/js.js?id=UA-23581568-13"></script>
    <script>

    ...
    <div class="row same-height justify-content-center">
        <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
                ...
                <h1 class="mb-4"><a href="#">The AI magically removes moving objects from
                    videos.</a></h1>
                    <div class="post-meta align-items-center text-center">
                        <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="{{asset('cssfontend')}}/images/person_1.jpg"
                            ...
                            <p>Quis eius aspernatur, eaque culpa cumque reiciendis, nobis at earum assumenda similique
                                ...
                                <div class="row mb-5 mt-5">
                                    <div class="col-md-12 mb-4">
                                     <img src="{{asset('cssfontend')}}/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <img src="{{asset('cssfontend')}}/images/img_2.jpg" alt="Image placeholder" class="img-fluid rounded">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <img src="{{asset('cssfontend')}}/images/img_3.jpg" alt="Image placeholder" class="img-fluid rounded">
                                    </div>
                                </div>
                                ...
                                <div class="pt-5">
                                    ...
                                    <div class="pt-5">
                                        ...
                                        <ul class="comment-list">
                                            <li class="comment">
                                                <div class="vcard">
                                                    <img src="{{asset('cssfontend')}}/images/person_1.jpg" alt="Image placeholder">
                                                </div>
                                                        ...
                                                        <li class="comment">
                                                            ...
                                                            <div class="comment-body">
                                                                ...
                                                                <ul class="children">
                                                                    <li class="comment">
                                                                        <div class="vcard">
                                                                            <img src="{{asset('cssfontend')}}/images/person_1.jpg"
                                                                        ...
                                                                        <div class="comment-body">
                                                                            ...
                                                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing
                                                                                ...
                                                                                <p><a href="#" class="reply rounded">Reply</a>
                                                                                </p>
                                                                            </div>
                                                                        </li>
                                                     </ul>
                                    ...
                                    <div class="sidebar-box">
                                        ...
                                        <div class="post-entry-sidebar">
                                            <ul>
                                                <li>
                                                    <a href="">
                                                        <img src="{{asset('cssfontend')}}/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                                                        <div class="text">
                                                ...
                                                <li>
                                                    <a href="">
                                                        <img src="{{asset('cssfontend')}}/images/img_2.jpg" alt="Image placeholder" class="mr-4">
                                                        <div class="text">
                                                            <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                                            <div class="post-meta">
                                                                <span class="mr-2">March 15, 2018 </span>
                                                ...
                                                <li>
                                                    <a href="">
                                                        <img src="{{asset('cssfontend')}}/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                                                        <div class="text">
                                                            <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                                            <div class="post-meta">
                                                                <span class="mr-2">March 15, 2018 </span>
